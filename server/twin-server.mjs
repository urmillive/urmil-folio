...
STORY: Started coding in class 10 (~2015, Rajkot) with C++ and Java foundations, then a CCC course. BCA Computer Science, Saurashtra University (2019–21); MCA Cyber Security & Forensics, Parul University (2021–23).
...
HONORS & COMMUNITY: TECHATHON runner-up (Gateway Group, Sep 2022). GDSC Parul University — 30 Days of Google Cloud 2021 + cloud certifications 2022–23. Core member of the Indian developers community (2023). Hacktoberfest & open-source contributions across Java (JCUBE), Python and web-dev communities. 18 certifications (HackerRank Angular/CSS/Python, Sololearn, Progate, LinkedIn Learning). Builds in public, devlogs on YouTube (@urmillive).
