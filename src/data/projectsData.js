/* The archive — every position that matters, by category. */
...
export const PROJECTS = [
  ...
  /* ---- open source & experiments ---- */
  { name: 'COLLEGE', cat: 'open source & experiments', desc: 'Java programs for BCA students — his most-starred repo', tech: 'Java · 12★', url: 'https://github.com/urmillive/COLLEGE' },
  { name: 'python-mini-projects', cat: 'open source & experiments', desc: 'The Python years, preserved in public', tech: 'Python', url: 'https://github.com/urmillive/python-mini-projects' },
  { name: 'urmil.live', cat: 'open source & experiments', desc: 'This site — the film you are inside right now', tech: 'Vite · WebAudio · zero frameworks', url: 'https://github.com/urmillive/urmil-folio' },
  { name: 'Snake Game', cat: 'open source & experiments', desc: 'The classic, hand-rolled', tech: 'JavaScript', url: 'https://github.com/urmillive/snakegame' },
]
